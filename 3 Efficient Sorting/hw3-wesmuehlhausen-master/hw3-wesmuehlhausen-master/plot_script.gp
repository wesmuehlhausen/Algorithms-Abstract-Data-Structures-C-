...
# implemented (where 1 is the first of potentially many tests).
#
...
if (testtype == "1") {
  ...
  plot infile u 1:2 t "ArrayList Merge Sort" w linespoints pointtype 7, \
       infile u 1:3 t "LinkedList Merge Sort" w linespoints pointtype 7, \
       infile u 1:4 t "ArrayList Quick Sort" w linespoints pointtype 7, \
       infile u 1:5 t "LinkedList Quick Sort" w linespoints pointtype 7
} else {
