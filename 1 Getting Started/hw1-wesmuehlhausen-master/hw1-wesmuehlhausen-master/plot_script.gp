...
#
#     gnuplot -c plot_script.gp "out.dat" "Add to End" "add_end.png"
#
#----------------------------------------------------------------------
...
# Plot the data
plot infile u 1:2 t "Resizable Array" w linespoints pointtype 7, \
     infile u 1:3 t "Linked List" w linespoints pointtype 7
